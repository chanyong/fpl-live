...
function kickoffLabel(fixture: LeagueFixture) {
  if (!fixture.kickoffTime) {
    return "";
  }

  return format(new Date(fixture.kickoffTime), "EEE, MMM d HH:mm");
}
                ...
                <div className="border-t border-[var(--border)] bg-white/88 px-3 py-3">
                  <div className="rounded-[0.9rem] border border-emerald-200 bg-emerald-50/60 px-3 py-2">
                    ...
                    <div className="mt-1 flex flex-wrap items-center justify-between gap-2">
                      ...
                      <div className="rounded-full bg-emerald-100 px-2.5 py-1 text-sm font-semibold text-emerald-800 tabular-nums">
                        {scoreLabel(fixture)}
                      </div>
                    </div>
                    <div className="mt-1 text-[12px] text-[var(--muted)]">
                      {fixtureStatus(fixture)}
                      {fixture.kickoffTime ? ` ? ${kickoffLabel(fixture)}` : ""}
                    </div>
                  </div>
